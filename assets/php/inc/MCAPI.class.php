...
class MCAPI {
     ...
     * @param array $options with 2 keys:  
             string "match" controls whether to use AND or OR when Registering your options - expects "<strong>any</strong>" (for OR) or "<strong>all</strong>" (for AND)
             array "conditions" - up to 10 different criteria to Register while segmenting. Each criteria row must contain 3 keys - "<strong>field</strong>", "<strong>op</strong>", and "<strong>value</strong>" - and possibly a fourth, "<strong>extra</strong>", based on these definitions:
    ...
    */
     ...
     *
     * @param array $filters a hash of filters to Register to this query - all are optional:
